...
urlpatterns = [
    ...
    path('password_change/', PasswordChangeView.as_view(template_name='password_change.html'),
         name='password_change'),
    path('password_change/done/', PasswordChangeDoneView.as_view(
        template_name='password_change_done.html'), name='password_change_done'),
    path('management_panel/', category_views.ManagementPanelView.as_view(), name='management_panel'),
    path('create_category/', category_views.CreateCategoryView.as_view(), name='create_category'),
    path('edit_category/<int:category_id>/',
         category_views.EditCategoryView.as_view(), name='edit_category'),
    path('delete_category/<int:category_id>/',
         category_views.DeleteCategoryView.as_view(), name='delete_category'),
    ...
    path('order_confirmed/<int:delivery_id>/',
         cart_views.OrderconfirmedView.as_view(), name='order_confirmed'),
    path('cart/increment/<int:item_id>/',
         cart_views.IncrementCartItemView.as_view(), name='increment_cart_item'),
    path('cart/decrement/<int:item_id>/',
         cart_views.DecrementCartItemView.as_view(), name='decrement_cart_item'),
    path('cart/remove/<int:item_id>/', cart_views.RemoveCartItemView.as_view(), name='remove_cart_item'),
    path('order_history/', delivery_views.ViewOrderHistoryView.as_view(), name='order_history'),
    path('manage_deliveries/', delivery_views.ManageDeliveriesView.as_view(), name='manage_deliveries'),
    path('mark_as_delivered/<int:delivery_id>/',
         delivery_views.MarkAsDeliveredView.as_view(), name='mark_as_delivered'),
